...
import { ButtonSecondary, ButtonExit, ButtonSetQuality } from '~/components/Button'
    ...
    <div className={cx('wrapper-modal-add-product')}>
      ...
      >
        ...
        <div className="flex items-center mb-4">
          <img src={product.image} alt={product.name} className="h-24 w-24 object-cover mr-4" />
          <div>
          ...
          <div className="flex space-x-2">
            {product.size.map((size, index) => (
              <button
                ...
                style={{
                  backgroundColor:
                    selectedSize === size ? 'var(--primary-color)' : 'var(--thirdary-color)',
